...
export enum Permission {
    ...
    VERIFY = 'VERIFY',
    RELEASE = 'RELEASE',
    PERSONAL_ACCOUNT_READ = 'PERSONAL_ACCOUNT_READ',
...
export const PersonalAccountApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        searchPersonalAccounts: async (roleName?: string, localPermissionsLabelId?: string, name?: string, activeKeyIds?: Array<string>, inactiveKeyIds?: Array<string>, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        updatePersonalAccountRolesById: async (accountId: string, requestBody: Array<string>, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'accountId' is not null or undefined
            if (accountId === null || accountId === undefined) {
            ...
            if (requestBody === null || requestBody === undefined) {
                throw new RequiredError('requestBody','Required parameter requestBody was null or undefined when calling updatePersonalAccountRolesById.');
            }
...
export const PersonalAccountApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async searchPersonalAccounts(roleName?: string, localPermissionsLabelId?: string, name?: string, activeKeyIds?: Array<string>, inactiveKeyIds?: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<PersonalAccount>>> {
            const localVarAxiosArgs = await PersonalAccountApiAxiosParamCreator(configuration).searchPersonalAccounts(roleName, localPermissionsLabelId, name, activeKeyIds, inactiveKeyIds, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async updatePersonalAccountRolesById(accountId: string, requestBody: Array<string>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PersonalAccount>> {
            const localVarAxiosArgs = await PersonalAccountApiAxiosParamCreator(configuration).updatePersonalAccountRolesById(accountId, requestBody, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const PersonalAccountApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        searchPersonalAccounts(roleName?: string, localPermissionsLabelId?: string, name?: string, activeKeyIds?: Array<string>, inactiveKeyIds?: Array<string>, options?: any): AxiosPromise<Array<PersonalAccount>> {
            return PersonalAccountApiFp(configuration).searchPersonalAccounts(roleName, localPermissionsLabelId, name, activeKeyIds, inactiveKeyIds, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary updates permissions of the personalaccount and label when the permissions list is empty the permissions are removed
         ...
         * @throws {RequiredError}
         */
        updatePersonalAccountRolesById(accountId: string, requestBody: Array<string>, options?: any): AxiosPromise<PersonalAccount> {
            return PersonalAccountApiFp(configuration).updatePersonalAccountRolesById(accountId, requestBody, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class PersonalAccountApi extends BaseAPI {
     ...
     * @memberof PersonalAccountApi
     */
    public searchPersonalAccounts(roleName?: string, localPermissionsLabelId?: string, name?: string, activeKeyIds?: Array<string>, inactiveKeyIds?: Array<string>, options?: any) {
        return PersonalAccountApiFp(this.configuration).searchPersonalAccounts(roleName, localPermissionsLabelId, name, activeKeyIds, inactiveKeyIds, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PersonalAccountApi
     */
    public updatePersonalAccountRolesById(accountId: string, requestBody: Array<string>, options?: any) {
        return PersonalAccountApiFp(this.configuration).updatePersonalAccountRolesById(accountId, requestBody, options).then((request) => request(this.axios, this.basePath));
    }
}
