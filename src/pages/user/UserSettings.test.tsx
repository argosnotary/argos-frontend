      ...
      roles: [
        {
          ...
          name: "jedi",
          permissions: [Permission.READ, Permission.LOCAL_PERMISSION_EDIT, Permission.TREE_EDIT, Permission.VERIFY]
        }
      ]
    };

    const root = mount(<WrappedUserSettings personalAccount={personalAccount} />);
